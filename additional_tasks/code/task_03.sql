...
VALUES
    ...
    (2, 'Петров ПП', '14-12-2022', 'Работа offline'),  
    (2, 'Петров ПП', '15-12-2022', 'Удаленная работа'),
    (2, 'Петров ПП', '16-12-2022', 'Удаленная работа'),
    (2, 'Петров ПП', '17-12-2022', 'Работа offline'),
    (3, 'Сидоров ПП', '19-12-2022', 'Работа offline');  
SELECT * FROM workers;
